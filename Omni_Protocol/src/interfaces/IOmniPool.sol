...
interface IOmniPool {
     ...
     */
    function setModeConfiguration(ModeConfiguration memory _modeConfiguration) external;
     ...
     */
    function setLiquidationBonusConfiguration(address _market, LiquidationBonusConfiguration memory _config) external;
