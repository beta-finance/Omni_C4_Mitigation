...
interface IOmniOracle {
    /// Events
    event SetOracle(address indexed underlying, address indexed oracle, Provider provider, uint32 delay, uint32 delayQuote);
    ...
    enum Provider {
        ...
        Band,
        Chainlink,
        Other // Must implement the IOmniOracle interface, use very carefully should return 1 full unit price multiplied by 1e18
    }
